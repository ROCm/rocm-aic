...
DEFAULT_CONTAINER_SERVER_LOG_DIR = "/var/log/vllm-radeon"

def container_data_root() -> Path:
    """In-container LMCache data root (**`RADEON_CONTAINER_DATA_DIR`**)."""
    v = os.environ.get("RADEON_CONTAINER_DATA_DIR", "").strip()
...
def container_server_log_dir() -> Path:
    ...
    v = os.environ.get("RADEON_SERVER_LOG_DIR", "").strip()
