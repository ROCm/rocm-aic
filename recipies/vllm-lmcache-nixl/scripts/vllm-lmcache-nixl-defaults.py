...
DEFAULT_CONTAINER_SERVER_LOG_DIR = "/var/log/vllm-lmcache-nixl"


def container_data_root() -> Path:
    """In-container LMCache data root (**`VLN_CONTAINER_DATA_DIR`**)."""
    v = os.environ.get("VLN_CONTAINER_DATA_DIR", "").strip()
...
def container_server_log_dir() -> Path:
    ...
    v = os.environ.get("VLN_SERVER_LOG_DIR", "").strip()
