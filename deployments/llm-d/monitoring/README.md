...
This directory manages Grafana dashboard installation for rocm-icms deployments.
...
2. **rocm-icms custom dashboards** - Custom dashboards in `grafana/dashboards/`
...
```bash
cd deployments/llm-d/monitoring
...
- `just load-custom-dashboards` - Load only rocm-icms custom
...
## rocm-icms Custom Dashboards

**Location**: `grafana/dashboards/`

Add your custom Grafana dashboard JSON files here. They will be:
- Loaded as ConfigMaps with prefix: `rocm-icms-*`
...
- rocm-icms: `rocm-icms-{dashboard-name}`
