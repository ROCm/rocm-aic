...
# LMCache IO Tester — usage

Detailed reference for patterns, Hugging Face integration, storage
backends, and metrics. See [README.md](../README.md) for install and
quick start.
...
Examples in this document often use **`gpt2`** for a small public checkpoint;
...
`tools/lmcache-io-tester/` or root `requirements.txt` change; see
`.github/workflows/lmcache-io-tester.yml`.
